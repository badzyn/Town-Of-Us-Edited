...
namespace TownOfUsEdited.CustomOption
{
    public class Generate
    {
        ...
        public static CustomNumberOption HelperOn;
        ...
        public static CustomNumberOption MutantOn;
        ...
        public static CustomHeaderOption CovenGameSettings;
        public static CustomNumberOption MinCoven;
        public static CustomNumberOption MaxCoven;
        ...
        public static CustomNumberOption RitualistOn;
        ...
        public static CustomToggleOption RitualistMultiKill;
        public static CustomToggleOption RitualistGuessNeutralBenign;
        public static CustomToggleOption RitualistGuessNeutralEvil;
        public static CustomToggleOption RitualistGuessNeutralKilling;
        ...
        public static CustomToggleOption FighterKillsNB;
        public static CustomToggleOption FighterKillsNE;
        public static CustomToggleOption FighterKillsNK;
        public static CustomToggleOption FighterKillsCoven;
        public static CustomToggleOption FighterKillsMadmate;
        ...
        public static CustomNumberOption KnightKCD;
        ...
        public static CustomToggleOption SheriffKillsNB;
        public static CustomToggleOption SheriffKillsMad;
        public static CustomToggleOption SheriffKillsCoven;
        ...
        public static CustomNumberOption GhostCooldown;
        public static CustomNumberOption GhostDuration;
        ...
        public static CustomToggleOption TrollHaunts;
        ...
        public static CustomNumberOption SerialKillerKCD;
        public static CustomToggleOption SerialKillerVent;
        public static CustomToggleOption SerialKillerCanConvert;
        ...
        public static CustomToggleOption DoppelVent;

        public static CustomHeaderOption Mutant;
        public static CustomNumberOption MutantKCD;
        public static CustomNumberOption TransformCD;
        public static CustomNumberOption TransformKCD;
        public static CustomToggleOption MutantVent;

        public static CustomHeaderOption Infectious;
        public static CustomNumberOption InfectiousCD;
        public static CustomNumberOption InfectiousInfectedCD;
        public static CustomNumberOption InfectedSpeed;
        public static CustomToggleOption InfectiousVent;
        ...
        public static CustomHeaderOption Doctor;
        public static CustomNumberOption DocReviveCooldown;
        public static CustomNumberOption MaxRevives;
        public static CustomToggleOption OnlyMedRevive;
        public static CustomNumberOption DoctorDragSpeed;

        public static CustomHeaderOption Bodyguard;
        public static CustomNumberOption BodyguardRadius;
        ...
        public static CustomNumberOption ChamSwoopCooldown;
        public static CustomNumberOption ChamSwoopDuration;

        public static CustomHeaderOption Helper;
        public static CustomNumberOption HelperCooldown;
        public static CustomNumberOption HelperDuration;
        public static CustomNumberOption HelperSpeed;
        ...
        public static CustomHeaderOption Manipulator;
        public static CustomNumberOption ManipulateCooldown;
        public static CustomNumberOption ManipulationDuration;
        ...
        public static CustomNumberOption TargetShortCooldown;
        public static CustomNumberOption TargetLongCooldown;
        public static CustomNumberOption TargetDuration;

        public static CustomHeaderOption Shooter;
        public static CustomNumberOption MaxStore;
        ...
        public static CustomHeaderOption Paranoïac;
        ...
        public static CustomNumberOption MafiosoKillTimer;
        ...
        public static CustomToggleOption MadmateKillEachOther;
        public static CustomToggleOption MadmateHasImpoVision;
        public static CustomToggleOption MadmateCanChat;
        public static CustomStringOption MadmateOnImpoDeath;
        ...
        public static void GenerateAll()
        {
            ...
            GuardianOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#67bb43>Guardian</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            HaunterOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#D3D3D3FF>Haunter</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            HelperOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#7cb6c2>Helper</color>", 0f, 0f, 100f, 10f,
                PercentFormat);

            CrewInvestigativeRoles = new CustomHeaderOption(num++, MultiMenu.crewmate, "Crewmate Investigative Roles");
            AstralOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#a703ae>Astral</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            CaptainOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#6B8DE1>Captain</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ChameleonOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#068c38>Chameleon</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            DetectiveOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#4D4DFFFF>Detective</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            InformantOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#4CFAAB>Informant</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            AvengerOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#216f01>Avenger</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            DeputyOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#FFCC00FF>Deputy</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            FighterOn = new CustomNumberOption(num++, MultiMenu.crewmate, "<color=#9358e6>Fighter</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            TrollOn = new CustomNumberOption(num++, MultiMenu.neutral, "<color=#c27d5a>Troll</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            VultureOn = new CustomNumberOption(num++, MultiMenu.neutral, "<color=#916e6e>Vulture</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            ArsonistOn = new CustomNumberOption(num++, MultiMenu.neutral, "<color=#FF4D00FF>Arsonist</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            AttackerOn = new CustomNumberOption(num++, MultiMenu.neutral, "<color=#c73a00>Attacker</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            DoppelgangerOn = new CustomNumberOption(num++, MultiMenu.neutral, "<color=#fadd84>Doppelganger</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            InfectiousOn = new CustomNumberOption(num++, MultiMenu.neutral, "<color=#bf9000>Infectious</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            ImpostorGhostRoles = new CustomHeaderOption(num++, MultiMenu.imposter, "Impostor Ghost Roles");
            BlinderOn = new CustomNumberOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Blinder</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            ConjurerOn = new CustomNumberOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Conjurer</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ManipulatorOn = new CustomNumberOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Manipulator</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            PoisonerOn = new CustomNumberOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Poisoner</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ShooterOn = new CustomNumberOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Shooter</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            BlackmailerOn = new CustomNumberOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Blackmailer</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ConverterOn = new CustomNumberOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Converter</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            MinerOn = new CustomNumberOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Miner</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ReviverOn = new CustomNumberOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Reviver</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            FrostyOn = new CustomNumberOption(num++, MultiMenu.modifiers, "<color=#99FFFFFF>Frosty</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            MadmateOn = new CustomNumberOption(num++, MultiMenu.modifiers, "<color=#FF0000FF>Madmate</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            MiniOn = new CustomNumberOption(num++, MultiMenu.modifiers, "<color=#CCFFE6FF>Mini</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            MotionlessOn = new CustomNumberOption(num++, MultiMenu.modifiers, "<color=#008591>Motionless</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            BloodlustOn = new CustomNumberOption(num++, MultiMenu.modifiers, "<color=#FF0000FF>Bloodlust</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            DoubleShotOn = new CustomNumberOption(num++, MultiMenu.modifiers, "<color=#FF0000FF>Double Shot</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            LuckyOn = new CustomNumberOption(num++, MultiMenu.modifiers, "<color=#FF0000FF>Lucky</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            AutoStart = new CustomToggleOption(num++, MultiMenu.main, "Auto Start As Host", false);
            ...
            ShiftTurnNeutAssassin = new CustomToggleOption(num++, MultiMenu.imposter, "Shifter Turned Neutral Killing Gets Ability", false);
            ...
            Astral =
                new CustomHeaderOption(num++, MultiMenu.crewmate, "<color=#a703ae>Astral</color>");
            GhostCooldown =
            ...
            WatchCooldown =
                new CustomNumberOption(num++, MultiMenu.crewmate, "Watch Ability Cooldown", 25f, 10f, 60f, 2.5f, CooldownFormat);
            WatchDuration =
            ...
            FighterKCD =
                new CustomNumberOption(num++, MultiMenu.crewmate, "Fighter Kill Cooldown", 25f, 10f, 40f, 2.5f, CooldownFormat);
            FighterKillsNB =
                new CustomToggleOption(num++, MultiMenu.crewmate, "Fighter Can Kill Neutral Benign", false);
            FighterKillsNE =
                new CustomToggleOption(num++, MultiMenu.crewmate, "Fighter Can Kill Neutral Evil", false);
            FighterKillsNK =
                new CustomToggleOption(num++, MultiMenu.crewmate, "Fighter Can Kill Neutral Killing", false);
            FighterKillsMadmate =
                new CustomToggleOption(num++, MultiMenu.crewmate, "Fighter Can Kill Madmate", false);
            FighterKillsCoven =
                new CustomToggleOption(num++, MultiMenu.crewmate, "Fighter Can Kill Coven Roles", false);
            ...
            KnightKCD =
                new CustomNumberOption(num++, MultiMenu.crewmate, "Knight Kill Cooldown", 25f, 10f, 60f, 2.5f, CooldownFormat);
            ...
            SheriffKillsNB =
                new CustomToggleOption(num++, MultiMenu.crewmate, "Sheriff Kills Neutral Benign", false);
            SheriffKillsNE =
                new CustomToggleOption(num++, MultiMenu.crewmate, "Sheriff Kills Neutral Evil", false);
            SheriffKillsNK =
                new CustomToggleOption(num++, MultiMenu.crewmate, "Sheriff Kills Neutral Killing", false);
            SheriffKillsMad =
                new CustomToggleOption(num++, MultiMenu.crewmate, "Sheriff Kills Madmate", false);
            SheriffKillsCoven =
                new CustomToggleOption(num++, MultiMenu.crewmate, "Sheriff Kills Coven Roles", false);
            SheriffKillCd =
            ...
            TrollHaunts =
                new CustomToggleOption(num++, MultiMenu.neutral, "Troll Haunts Player On Victory", true);

            Vulture =
                new CustomHeaderOption(num++, MultiMenu.neutral, "<color=#916e6e>Vulture</color>");
            VultureCooldown =
                new CustomNumberOption(num++, MultiMenu.neutral, "Vulture Cooldown", 15f, 10f, 60f, 2.5f, CooldownFormat);
            VultureVent =
            ...
            TerroristKillCooldown =
                new CustomNumberOption(num++, MultiMenu.neutral, "Terrorist Kill Cooldown", 25f, 10f, 60f, 2.5f, CooldownFormat);
            TerroristVent =
                new CustomToggleOption(num++, MultiMenu.neutral, "Terrorist Can Vent", false);

            Doppelganger = new CustomHeaderOption(num++, MultiMenu.neutral, "<color=#fadd84>Doppelganger</color>");
            DoppelKCD =
                new CustomNumberOption(num++, MultiMenu.neutral, "Doppelganger Kill Cooldown", 25f, 10f, 60f, 2.5f, CooldownFormat);
            DoppelVent =
                new CustomToggleOption(num++, MultiMenu.neutral, "Doppelganger Can Vent", false);

            Infectious =
                new CustomHeaderOption(num++, MultiMenu.neutral, "<color=#bf9000>Infectious</color>");
            InfectiousCD =
                new CustomNumberOption(num++, MultiMenu.neutral, "Infectious Cooldown", 25f, 10f, 60f, 2.5f, CooldownFormat);
            InfectiousInfectedCD =
                new CustomNumberOption(num++, MultiMenu.neutral, "Infectious Cooldown When Killing Infected", 10f, 5f, 60f, 2.5f, CooldownFormat);
            InfectedSpeed = new CustomNumberOption(num++, MultiMenu.neutral, "Infected Speed Decrease", 0.75f, 0.25f, 0.95f, 0.05f, MultiplierFormat);
            InfectiousVent =
                new CustomToggleOption(num++, MultiMenu.neutral, "Infectious Can Vent", false);
            ...
            MutantKCD =
                new CustomNumberOption(num++, MultiMenu.neutral, "Mutant Initial Kill Cooldown", 35f, 20f, 60f, 5f, CooldownFormat);
            TransformCD =
                new CustomNumberOption(num++, MultiMenu.neutral, "Mutant Transform Cooldown", 45f, 20f, 60f, 5f, CooldownFormat);
            TransformKCD =
                new CustomNumberOption(num++, MultiMenu.neutral, "Kill Cooldown When Transformed", 5f, 2f, 10f, 1f, CooldownFormat);
            MutantVent =
                new CustomToggleOption(num++, MultiMenu.neutral, "Mutant Can Vent When Transformed", false);
            ...
            SerialKillerCanConvert =
                new CustomToggleOption(num++, MultiMenu.neutral, "Serial Killer Can Convert A Player", false);
            SKConvertImp =
                new CustomToggleOption(num++, MultiMenu.neutral, "Serial Killer Can Convert Impostors / Madmates", false);
            SKConvertNK =
                new CustomToggleOption(num++, MultiMenu.neutral, "Serial Killer Can Convert Neutral Killers", false);
            SKConvertCoven =
            ...
            BiteCooldown =
                new CustomNumberOption(num++, MultiMenu.neutral, "Vampire Cooldown", 25f, 10f, 60f, 2.5f, CooldownFormat);
            VampImpVision =
            ...
            BlindDuration =
                new CustomNumberOption(num++, MultiMenu.imposter, "Blind Duration", 10f, 5f, 15f, 1f, CooldownFormat);

            Freezer =
                new CustomHeaderOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Freezer</color>");
            FreezeCooldown =
                new CustomNumberOption(num++, MultiMenu.imposter, "Freeze Cooldown", 25f, 10f, 60f, 2.5f, CooldownFormat);
            FreezeDuration =
            ...
            TargetShortCooldown =
                new CustomNumberOption(num++, MultiMenu.imposter, "Kill Cooldown When Killing Target", 7.5f, 2.5f, 40f, 2.5f, CooldownFormat);
            TargetLongCooldown =
                new CustomNumberOption(num++, MultiMenu.imposter, "Kill Cooldown When Killing Other", 45f, 20f, 80f, 2.5f, CooldownFormat);
            TargetDuration =
                new CustomNumberOption(num++, MultiMenu.imposter, "Time Before Target Switch", 60f, 20f, 80f, 2.5f, CooldownFormat);

            Manipulator =
                new CustomHeaderOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Manipulator</color>");
            ManipulateCooldown =
            ...
            Shooter =
                new CustomHeaderOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Shooter</color>");
            MaxStore = new CustomNumberOption(num++, MultiMenu.imposter, "Maximum Number Of Stored Bullets", 3, 1, 5, 1);
            ...
            Mafioso = new CustomHeaderOption(num++, MultiMenu.imposter, "<color=#FF0000FF>Mafioso</color>");
            MafiosoKillTimer =
                new CustomNumberOption(num++, MultiMenu.imposter, "Kill Cooldown", 20f, 10f, 60f, 2.5f, CooldownFormat);
            ...
            HexMasterOn = new CustomNumberOption(num++, MultiMenu.coven, "<color=#bf5fff>Hex Master</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            RitualistOn = new CustomNumberOption(num++, MultiMenu.coven, "<color=#bf5fff>Ritualist</color>", 0f, 0f, 100f, 10f,
                PercentFormat);

            CovenSupportRoles =
                new CustomHeaderOption(num++, MultiMenu.coven, "<color=#bf5fff>Coven</color> Support Roles");
            CovenLeaderOn = new CustomNumberOption(num++, MultiMenu.coven, "<color=#bf5fff>Coven Leader</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            PotionMasterOn = new CustomNumberOption(num++, MultiMenu.coven, "<color=#bf5fff>Potion Master</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            SpiritualistOn = new CustomNumberOption(num++, MultiMenu.coven, "<color=#bf5fff>Spiritualist</color>", 0f, 0f, 100f, 10f,
                PercentFormat);
            ...
            PotionCD =
                new CustomNumberOption(num++, MultiMenu.coven, "Potion Cooldown", 25f, 10f, 60f, 2.5f, CooldownFormat);
            PotionDuration =
            ...
            Madmate = new CustomHeaderOption(num++, MultiMenu.modifiers, "<color=#FF0000FF>Madmate</color>");
            MadmateKillEachOther = new CustomToggleOption(num++, MultiMenu.modifiers, "Madmates & Impostors Can Kill Each Other");
