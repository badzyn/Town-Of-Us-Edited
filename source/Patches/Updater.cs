...
namespace TownOfUsEdited
{
    ...
    public class ModUpdaterButton
    {
        ...
        {
            var text = ModUpdater.Httpclient.GetAsync("https://raw.githubusercontent.com/badzyn/Town-Of-Us-Edited/refs/heads/master/source/Versioning.json")
    ...
    public class ModUpdater
    {
        ...
        public static async Task<bool> checkForUpdate(string updateType = "TOU")
        {
            ...
            try
            {
                ...
                if (updateType == "TOU")
                {
                    githubURI = "https://api.github.com/repos/badzyn/Town-Of-Us-Edited/releases/latest";
                }
                else if (updateType == "Submerged")
                {
